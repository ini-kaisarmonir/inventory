            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" step="0.01" name="discount" value="0" 
                        class="w-full placeholder:text-gray-400 pl-7 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:outline-none">
                </div>
            </div>
            ...
            <div>
                ...
                <div class="relative">
                    <input type="number" step="0.01" name="vat_percent" value="5" 
                        class="w-full placeholder:text-gray-400 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:outline-none">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" step="0.01" name="paid" value="0" 
                        class="w-full placeholder:text-gray-400 pl-7 pr-4 py-2 border border-gray-300 rounded-lg border-green-500 bg-green-50 focus:ring-2 focus:ring-green-600 focus:outline-none font-bold text-green-700">
                </div>
            </div>
        </div>

        <div class="mt-8">
            <button type="submit" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-md transition duration-300 ease-in-out shadow-sm transform active:scale-95">
                Complete Sale
            </button>
        </div>
    </form>
